                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="first_name">First {{ trans('backpack::base.name') }}</label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="last_name">Last {{ trans('backpack::base.name') }}</label>
